      ...
      <main className="flex-1">
        <div className="container py-4 sm:py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 mb-8 lg:mb-16">
            ...
            <div>
              <div className="mb-4 sm:mb-6">
                ...
                <h1 className="text-2xl sm:text-3xl font-light mt-1 sm:mt-2 mb-2 sm:mb-3">
                  {product.name}
                </h1>
                ...
                <div className="max-w-3xl">
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="grid grid-cols-1 sm:grid-cols-3 py-3 border-b">
                      ...
                      <span className="sm:col-span-2">
                        {product.heartNotes || "N/A"}
                      </span>
                    </li>
                    <li className="grid grid-cols-1 sm:grid-cols-3 py-3 border-b">
                      <span className="font-medium">Base Notes</span>
                      <span className="sm:col-span-2">
                        {product.baseNotes || "N/A"}
                      </span>
                    </li>
                    <li className="grid grid-cols-1 sm:grid-cols-3 py-3 border-b">
              ...
              <TabsContent value="ingredients" className="pt-6">
                <div className="max-w-3xl">
                  ...
                  <p className="text-sm text-neutral-500">
                    ...
                    from time to time. Please refer to the ingredient list on
                    the product package for the most up-to-date list.
                  </p>
                </div>
              </TabsContent>
          ...
          {relatedProducts.length > 0 && (
            <div className="mb-8 sm:mb-16">
              <h2 className="text-xl sm:text-2xl font-light mb-4 sm:mb-8">
                You May Also Like
              </h2>
